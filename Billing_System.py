...
Checkbutton(root,text='macroni(120)     ',variable=v1,onvalue=1,anchor=W,width=15,bg='DarkGoldenrod4').grid(row=2,column=0)
Checkbutton(root,text='sandwich(50)     ',variable=v2,onvalue=2,anchor=W,width=15,bg='DarkGoldenrod4').grid(row=3,column=0)
Checkbutton(root,text='sabzi paratha(20)',variable=v3,onvalue=3,anchor=W,width=15,bg='DarkGoldenrod4').grid(row=4,column=0)
Checkbutton(root,text='poha(15)         ',variable=v4,onvalue=4,anchor=W,width=15,bg='DarkGoldenrod4').grid(row=5,column=0)
Checkbutton(root,text='noodles(12)     ',variable=v5,onvalue=5,anchor=W,width=15,bg='DarkGoldenrod4').grid(row=6,column=0)
Checkbutton(root,text='egg(20)          ',variable=v6,onvalue=6,anchor=W,width=15,bg='DarkGoldenrod4').grid(row=7,column=0)
Checkbutton(root,text='chilli potato (60)         ',variable=v7,onvalue=7,anchor=W,width=15,bg='DarkGoldenrod4').grid(row=8,column=0)
Checkbutton(root,text='upma(70)         ',variable=v8,onvalue=8,anchor=W,width=15,bg='DarkGoldenrod4').grid(row=9,column=0)

Checkbutton(root,text='pavbhaji(110)   ',variable=v9,onvalue=9,anchor=W,width=15,bg='DarkGoldenrod4').grid(row=2,column=2)
Checkbutton(root,text='pasta(80)       ',variable=v10,onvalue=10,anchor=W,width=15,bg='DarkGoldenrod4').grid(row=3,column=2)
